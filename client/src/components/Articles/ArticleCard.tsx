...
const navigate = useNavigate();
    return (
        <div onClick={() => navigate(`/article/${id}`)} className="rounded-lg border bg-card shadow-md flex flex-col justify-center items-start m-2 p-2 cursor-pointer hover:shadow-lg">
